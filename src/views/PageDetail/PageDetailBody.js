            ...
            <div>
                        ...
                        <div className="container-fliud">
                            <div className="wrapper row">
                                <div className="preview col-md-6">
                                    ...
                                    <div className="tab-pane active" id="pic-1"><img alt="" src="http://placekitten.com/400/252" /></div>
                ...
                <div className="container">
                    <div className="card">
                        ...
                        <div className="card-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse tempus tristique arcu, ac pharetra risus vulputate euismod. Nam mi arcu, sollicitudin id malesuada a, pretium vel diam. Vestibulum eget sapien ex. Praesent molestie nisi orci, ac laoreet nisi finibus vel. Sed et mi erat. Nam vulputate nisl dolor, vitae dignissim nulla commodo sed. Vestibulum quis ex est. Donec pulvinar tellus nec facilisis hendrerit.</div> 
                    </div>
                </div>
