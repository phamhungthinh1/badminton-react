                            ...
                            <div className="wrapper row">
                                ...
                                <div className="details col-md-6">
                                    ...
                                    <div className="action">
                                        <button className="add-to-cart btn btn-default mt-1" type="button">add to cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
