                    ...
                    <div className="col-md-6">
                        {/* <form action="" className="form-inline mw-100"> */}
                            <div className="input-group w-100">
                                <input className="form-control border" type="text" placeholder="Search" aria-label="Search" id="search" value={this.state.keyword} onChange={this.changeKeyword}/>
                                <div className="input-group-append">
                                    {/* <Link to="/searchproduct" > */}
                                        <button className="btn btn-primary" onClick={() => this.setKeyword()}>
